...
fonction_simulation <- function(n_prob, n_non_prob, theta1, theta2, theta3,
  ...
  return(c(biais_relatif_total_prob, biais_relatif_total_naif,
           biais_relatif_total_c, biais_relatif_total_inc, 
           biais_relatif_moyenne_prob, biais_relatif_moyenne_naif,
           biais_relatif_moyenne_c, biais_relatif_moyenne_inc))
}